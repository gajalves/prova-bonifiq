...
namespace ProvaPub.Controllers
{
    ...
    public class Parte2Controller : ControllerBase
    {
        ...
        public Parte2Controller(IProductService productService,
        ...
        [HttpGet("products")]
        public async Task<GenericList<Product>> ListProductsAsync(int page)
        {
            return await _productService.ListAsync(page);
        }

        [HttpGet("customers")]
        public async Task<GenericList<Customer>> ListCustomersAsync(int page)
        {
